...
pub(super) fn translate_update_mask(raw_mask: u32) -> u32 {
    ...
    // door updates carry the legacy facing WORD in the generic tail; the typed
    // update writer converts that WORD to EE's scalar branch. Do not drop this
    // bit here, or doors keep stale/default facing and visibly miss their frame.
