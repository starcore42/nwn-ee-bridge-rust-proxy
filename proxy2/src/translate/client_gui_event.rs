...
mod tests {
    ...
    fn observed_starc5_ee_gui_event_notify_vector_shape_is_claimed() {
        let payload = [
            0x70, 0x35, 0x01, 0x1B, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00,
    ...
    fn legacy_gui_event_notify_without_vector_shape_is_claimed() {
        let payload = [
            0x70, 0x35, 0x01, 0x0F, 0x00, 0x00, 0x00, 0x02, 0x00, 0x03, 0x00, 0xEF,
            0xBE, 0xAD, 0xDE,
        ];
    ...
    fn gui_event_notify_rejects_unproven_declared_lengths() {
        let payload = [
            0x70, 0x35, 0x01, 0x13, 0x00, 0x00, 0x00, 0x02, 0x00, 0x03, 0x00, 0xEF,
