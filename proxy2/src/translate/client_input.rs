...
pub struct ClientInputClaimSummary {
    ...
    pub use_item_active_property_subtype: Option<u8>,
    pub use_item_has_optional_byte: Option<bool>,
    pub use_item_has_target_object: Option<bool>,
    pub use_item_target_object_id: Option<u32>,
    pub use_item_has_position: Option<bool>,
...
fn claim_or_rewrite_payload_inner(
    ...
    if high.major == INPUT_MAJOR && high.minor == USE_ITEM_MINOR {
        ...
        return Some(ClientInputClaimSummary {
            ...
            use_item_active_property_subtype: Some(use_item.active_property_subtype),
            use_item_has_optional_byte: Some(use_item.optional_byte.is_some()),
            use_item_has_target_object: Some(use_item.target_object_id.is_some()),
            use_item_target_object_id: use_item.target_object_id,
            use_item_has_position: Some(use_item.position.is_some()),
